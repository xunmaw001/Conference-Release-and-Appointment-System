<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会议时间" prop="huiyishijian">
          <el-input v-model="ruleForm.huiyishijian" 
              placeholder="会议时间" clearable  :readonly="ro.huiyishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会议时间" prop="huiyishijian">
              <el-input v-model="ruleForm.huiyishijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会议人数" prop="huiyirenshu">
          <el-input v-model="ruleForm.huiyirenshu" 
              placeholder="会议人数" clearable  :readonly="ro.huiyirenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会议人数" prop="huiyirenshu">
              <el-input v-model="ruleForm.huiyirenshu" 
                placeholder="会议人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
	...
	this.ruleForm.huiyineirong = this.ruleForm.huiyineirong.replace(reg,'../../../ssmyrn40/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fabuhuiyi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fabuhuiyiCrossAddOrUpdateFlag = false;
                  this.parent.search();
