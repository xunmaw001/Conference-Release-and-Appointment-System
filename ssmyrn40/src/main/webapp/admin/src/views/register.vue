  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(229, 238, 229, 0.46);borderRadius:10px">
        <h1 class="h1" style="color:rgba(24, 103, 228, 1);fontSize:28px;">会议发布与预约系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="账号" class="input" v-if="tableName=='fabuzhe'">
			...
			<el-form-item label="姓名" class="input" v-if="tableName=='fabuzhe'">
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210505/19e7e20e261e486f8cf9fccfa861a819.jpg");
		height: 100vh;
