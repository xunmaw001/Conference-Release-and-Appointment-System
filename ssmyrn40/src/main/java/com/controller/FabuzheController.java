...
public class FabuzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		FabuzheEntity user = fabuzheService.selectOne(new EntityWrapper<FabuzheEntity>().eq("zhanghao", username));
    ...
    public R register(@RequestBody FabuzheEntity fabuzhe){
    	...
    	FabuzheEntity user = fabuzheService.selectOne(new EntityWrapper<FabuzheEntity>().eq("zhanghao", fabuzhe.getZhanghao()));
		if(user!=null) {
